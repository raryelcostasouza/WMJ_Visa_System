...
public class CtrProfile
{
    ...
    public CtrProfile(CtrDatabase ctrDatabase)
    {
    ...
    public String addProfile()
    {
        ...
        errorMessage = "Unable to add new Profile.";
        ...
        try
        {
            ...
            p.setNickname("New Profile " + generatedID);
    ...
    public int addEntryReentry(Profile p, PassportScan psArriveStamp)
    {
        ConstraintViolationException cve;
    ...
    public ArrayList<String> loadProfileNicknameList(boolean onlyActive)
    {
        ...
        listProfile = ctrDatabase.getSession().createQuery(hql, Profile.class).getResultList();
    ...
    public Profile loadProfileByIndex(int index)
    {
        ...
        alProfile = (ArrayList<Profile>) ctrDatabase.getSession().createQuery(hql, Profile.class).getResultList();
    ...
    public Profile loadProfileByNickName(String nickName)
    {
        String hql;

        hql = "from Profile p where p.nickname = " + "'" + nickName + "'";
        return queryProfile(hql);
    }

    public Profile loadProfileByID(Integer id)
    {
        Profile p;
        try
        {
    ...
    private Profile queryProfile(String hql)
    {
        ArrayList<Profile> alProfile;

        alProfile = (ArrayList<Profile>) ctrDatabase.getSession().createQuery(hql).getResultList();
