...
{
    public ResidenceGuaranteeLetterSNPVisaExtension(MonasticProfile p, CtrConfigFiles objCtrConfigFiles)
    {
        super(AppFiles.getODTResidenceGuaranteeLetterSNPVisaExtension(p.getMonasteryResidingAt()), p, objCtrConfigFiles);
    }
}
